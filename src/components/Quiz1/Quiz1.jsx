        ...
        for (var i=0; i<preguntas.length; i++){
            if(preguntas[i].checked){
                if(preguntas[i].value===0){
                   ...
                   var error = '<div class="app"><div class="caja"><div class="titulo_incorrecto">INCORRECTO</div><div class="tip">Aunque no estes usando el cargador, si lo dejas conectado sigue consumiendo energía y contribuyendo al cambio climático, por eso los llaman vampiros de la energía. Lo mismo pasa con el resto de tus aparatos si los dejas conectados. La mejor opción es comprar barras multicontacto, así podrás desconectar todo de un solo movimiento</div><div class="next"><a style="color:#93d4d7; text-decoration:none;" href="#/quiz2">SIGUIENTE</a></div></div></div>';
                   $(".background").append(error);
                    ...
                    var co = document.getElementById("container").remove();
                    var tip = '<div class="app"><div class="caja"><div class="titulo_correcto">CORRECTO</div><div class="tip">Aunque no estes usando el cargador, si lo dejas conectado sigue consumiendo energía y contribuyendo al cambio climático, por eso los llaman vampiros de la energía. Lo mismo pasa con el resto de tus aparatos si los dejas conectados. La mejor opción es comprar barras multicontacto, así podrás desconectar todo de un solo movimiento</div><div class="next"><a style="color:#93d4d7; text-decoration:none;" href="#/quiz2">SIGUIENTE</a></div></div></div>';
...
const imagen = data.map((respuesta,i) => {
        return(
            <img width="830" height="380" style={{display:respuesta.correcto===0 ? "none":"block"}} className={"img_quiz1"} src={eval("hab_"+(i+1))} alt="hab1"/>
        );
    });
    return(
        ...
        <div className="background">
            <div className="app">
                ...
                <div className="container_quiz" id="container">
